        ...
        <div class="col-md-12">
          ...
          <?php
            while($linhas = mysqli_fetch_array($resultado)){
                ...
                echo "<td>".$linhas['Registro']."</td>";?>
                        <td>
                        <a href='visualizar_usuario.php?id=<?php echo $linhas['Codigo']; ?>'><button type='button' class='btn btn-sm btn-primary'>Visualizar</button></a>
                      - <a href='editar_cancion.php?id=<?php echo $linhas['Codigo']; ?>'><button type='button' class='btn btn-sm btn-warning'>Editar</button></a>
                      - <a href='processa/proc_apagar_usuario.php?id=<?php echo $linhas['Codigo']; ?>'><button type='button' class='btn btn-sm btn-danger'>Eliminar</button></a>
                      <?php
                echo "</tr>";
            }
          ?>
