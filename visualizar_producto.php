  ...
  ?>
    ...
    <div class="col-md-12">
            <div class="col-sm-9 col-md-11">
               <b> ID: </b> <?php echo $resultado['id_producto'];?>
            </div>
            <div class="col-sm-9 col-md-11">
            ...
            <div class="col-sm-9 col-md-11">
               <b> Precio: </b> <?php echo $resultado['precio'];?>
            </div>
        </div>
    </div>
    <div class="row">
            <div class="pull-right">
                    <a href='listar_producto.php?id=<?php echo $resultado['id_producto']; ?>'><button type='button' class='btn btn-sm btn-info'>Listar</button></a>
							
                    <a href='editar_producto.php?id=<?php echo $resultado['id_producto']; ?>'><button type='button' class='btn btn-sm btn-warning'>Editar</button></a>
			
			        <a href='processa/proc_apagar_producto.php?id=<?php echo $resultado['id_producto']; ?>'><button type='button' class='btn btn-sm btn-danger'>Apagar</button></a>
            </div>
        </div>
    </div> <!-- /container -->
